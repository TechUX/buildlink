...
buildlink has ability to shorten any long url into short url using 5 different service providers along with custom alias for shorten link
 ...
 <br>**Note :** ```alias``` for link shortening must be less than 30 characters. <br><br>
...
```
[See Examples](https://github.com/TechUX/buildlink/edit/main/README.md#examples)
...
long_url = "https://github.com/TechUX/pylink/blob/main/README.md"
...
# Output : https://github.com/TechUX/pylink/blob/main/README.md
```
...
pylink supports a wide range of URL shortening services, including t.co, goo.gl, bit.ly, amzn.to, tinyurl.com, ow.ly, youtu.be, rg.gy, adf.ly and many others.
...
Try this package now. [Its available on pypy](https://pypi.org/project/buildlink/).
# Author & License
